 ...
 const slides: Slide[] = [
  {
    ...
    title: "WELCOME TO S.S. CONSULTANTS",
    button: "know-more",
  },
  {
    image: "https://res.cloudinary.com/dtxi8vdkq/image/upload/v1763102297/build4_zcawhm.jpg",
    title: "Structural Engineers Architects Temple Architects",
    button: "gallery",
  },
  {
...
<h2 className="text-4xl md:text-5xl font-bold mb-8 uppercase max-w-[700px] md:max-w-[800px] mx-auto leading-tight">
  {slide.title}
        ...
        {slide.button === "know-more" && (
          <button
            onClick={() => setActiveSection("services")}
            className="bg-[#fd5d14] hover:bg-orange-700 px-8 py-3 text-lg font-semibold rounded-sm shadow-lg transition"
          >
            KNOW MORE
          </button>
        )}
        ...
        {slide.button === "gallery" && (
          <button
            ...
            className="bg-[#fd5d14] hover:bg-orange-700 text-white px-8 py-3 text-lg font-semibold rounded-sm shadow-lg transition"
          >
            GALLERY
          </button>
        )}
  ...
  <button
    onClick={prevSlide}
    className="absolute left-4 top-1/2 -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 p-3 rounded-full shadow-lg transition"
  >
  ...
  <button
    onClick={nextSlide}
    className="absolute right-4 top-1/2 -translate-y-1/2 bg-white bg-opacity-80 hover:bg-opacity-100 p-3 rounded-full shadow-lg transition"
  >
